...
let g:which_key_map.l = {
      ...
      \ 'R' : [':Telescope lsp_references theme=dropdown layout_config={height=0.75,width=.70,prompt_position="top"}'                  , 'rename'],
      \ 'r' : [':Telescope lsp_references layout_config={height=0.65,width=.60,prompt_position="top"}'                                      , 'references'],
      \ 's' : [''     , 'Document Symbols'],
